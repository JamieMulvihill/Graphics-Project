...
TreeSegmentMesh::TreeSegmentMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int lresolution)
{
...
// Release resources.
TreeSegmentMesh::~TreeSegmentMesh()
{
...
void TreeSegmentMesh::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
