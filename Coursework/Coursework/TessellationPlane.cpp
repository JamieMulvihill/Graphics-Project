...
TessellationPlane::TessellationPlane(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int resolution)
{
...
void TessellationPlane::initBuffers(ID3D11Device* device)
{
	...
	vertexCount = (resolution_ - 1) * (resolution_ - 1) * 6;
...
void TessellationPlane::sendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
