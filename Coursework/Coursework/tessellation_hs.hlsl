...
ConstantOutputType PatchConstantFunction(InputPatch<InputType, 4> inputPatch, uint patchId : SV_PrimitiveID)
{
	...
	// calculating the mid point of each edge
	...
	// with the midpoit calculated, the distance is calculated to the camera
	...
	// getting the centre point by averaging the control point positions
	...
	// calculating the tessesllation factor by subtracting from max tessellation 
